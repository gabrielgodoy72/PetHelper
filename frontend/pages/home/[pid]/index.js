  ...
  useEffect(() => {
    if (archivos.length && imagenes.length) {
      ...
      setListArchivos(
        archivos
          .filter((a) => {
            return a.Id !== id && a.Estado.Nombre === "Para Adoptar";
          })
          .reverse()
      );
    }
          ...
          <Menu title={"Inicio"} onShowAll={handleShowAll} showAll={showAll}>
            ...
            {showAll && (
              <div style={{ height: "25rem" }}>
                ...
                <div className="p-1">
                  <p className="info">
                    <b>Requisitos que solicita el dueño</b>
                  </p>
                  <p className="info mx-2">
                    {prevArchivo.Descripcion
                      ? prevArchivo.Descripcion
                ...
                <Link href={`/perfil/${prevArchivo.Usuario.Id}`}>
                  <div className="bg-three btn-user d-flex justify-content-between pointer">
                    <div className="d-flex">
                      <img
                        src={`/profile${prevArchivo.Usuario.Id}.jpg`}
                        className="rounded-circle"
                        alt="user icon"
                        width="30"
                      />
                      <span style={{ fontSize: "14px", marginTop:'5%' }} className="mx-2">
